...
{synopt:{opt position_true_discont(integer -1)}}Position of the expected discontinuity {cmd:true_discont} in the vector {cmd:placebo_disconts}{p_end}
...
{synopt:{opt skip_install}}skip the installation of required packages.{p_end}
...
{phang} All dependent packages will automatically download at the first run of rdpermute. See {cmd: skip_install} for surpressing the installation.{p_end}
